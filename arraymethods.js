...
async function afunc() {//alternative or short form of promise and the time out catch and then
    try{//better alternative than .catch nd .
    ...
    let asyncname = async() => {//alternative or short form of promise and the time out catch and then
        try{//better alternative than .catch nd .
        let result=await attendconcert();
        console.log(result)
        }
    ...
    // const afunc=async () => {
    // let result = await attendoncert();
    // return result
    // }
    console.log("HI!! I AM DYING!! I Dont wait for anyone")
